 ...
 * Besides basic {@link external.instrumented.java15.util.Collection Collection} operations, queues provide
 ...
 * external.instrumented.java15.util.Collection#add Collection.add} method, which can fail to
 ...
 * defined in the {@link external.instrumented.java15.util.concurrent.BlockingQueue} interface, which
 ...
 *
 * @see external.instrumented.java15.util.Collection
 * @see LinkedList
 * @see PriorityQueue
 * @see external.instrumented.java15.util.concurrent.LinkedBlockingQueue
 * @see external.instrumented.java15.util.concurrent.BlockingQueue
 * @see external.instrumented.java15.util.concurrent.ArrayBlockingQueue
 * @see external.instrumented.java15.util.concurrent.LinkedBlockingQueue
 * @see external.instrumented.java15.util.concurrent.PriorityBlockingQueue
 * @since 1.5
 * @author Doug Lea
