 ...
 * method of <tt>String</tt> or the external.instrumented.java15.util.regex package instead.
 * <p>
...
class StringTokenizer implements Enumeration<Object> {
     ...
     * @see     external.instrumented.java15.util.StringTokenizer#hasMoreTokens()
     */
     ...
     *               tokenizer's string.
     * @see        external.instrumented.java15.util.Enumeration
     * @see        external.instrumented.java15.util.StringTokenizer#nextToken()
     */
