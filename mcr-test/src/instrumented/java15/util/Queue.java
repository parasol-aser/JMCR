 ...
 * Besides basic {@link benchmarks.instrumented.java15.util.Collection Collection} operations, queues provide
 ...
 * benchmarks.instrumented.java15.util.Collection#add Collection.add} method, which can fail to
 ...
 * defined in the {@link benchmarks.instrumented.java15.util.concurrent.BlockingQueue} interface, which
 ...
 *
 * @see benchmarks.instrumented.java15.util.Collection
 * @see LinkedList
 * @see PriorityQueue
 * @see benchmarks.instrumented.java15.util.concurrent.LinkedBlockingQueue
 * @see benchmarks.instrumented.java15.util.concurrent.BlockingQueue
 * @see benchmarks.instrumented.java15.util.concurrent.ArrayBlockingQueue
 * @see benchmarks.instrumented.java15.util.concurrent.LinkedBlockingQueue
 * @see benchmarks.instrumented.java15.util.concurrent.PriorityBlockingQueue
 * @since 1.5
 * @author Doug Lea
