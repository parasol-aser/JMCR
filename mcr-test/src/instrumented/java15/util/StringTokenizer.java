 ...
 * method of <tt>String</tt> or the benchmarks.instrumented.java15.util.regex package instead.
 * <p>
...
class StringTokenizer implements Enumeration<Object> {
     ...
     * @see     benchmarks.instrumented.java15.util.StringTokenizer#hasMoreTokens()
     */
     ...
     *               tokenizer's string.
     * @see        benchmarks.instrumented.java15.util.Enumeration
     * @see        benchmarks.instrumented.java15.util.StringTokenizer#nextToken()
     */
