  ...
  xaHelper()
  {
		 ...
		 throws SQLException
	{
		...
		try {
			...
			//Added by Jeff Huang
			currentDataSource = new org.apache.derby.jdbc.EmbeddedDataSource();
		 ...
		 throws SQLException
	{
		try {
			...
			//Added by Jeff Huang
			currentCPDataSource = new org.apache.derby.jdbc.EmbeddedConnectionPoolDataSource();
...
//					(Class.forName("com.ibm.db2.jcc.DB2XADataSource").newInstance());
			//Added by Jeff Huang
			//return new com.ibm.db2.jcc.DB2XADataSource();
			throw new RuntimeException("Added by Jeff Huang: missing com.ibm.db2.jcc.DB2XADataSource");
			else if (isNetClient){
                            if (JVMInfo.JDK_ID >= JVMInfo.J2SE_16) {
                                ...
                                try {
                                    ...
                                    //Added by Jeff Huang
//                                    return new org.apache.derby.jdbc.ClientXADataSource40();
                                }
                            ...
                            //Added by Jeff Huang
//                            return new org.apache.derby.jdbc.ClientXADataSource();
                        }
			else {
                            if (JVMInfo.JDK_ID >= JVMInfo.J2SE_16) {
                                //running under jdk1.6 or higher 
...
//                                        "EmbeddedXADataSource40").newInstance());    
                                    //Added by Jeff Huang
                                  return  new org.apache.derby.jdbc.EmbeddedXADataSource40();  
                                }
                                catch (Exception e) {
                                    //probably it was not compiled with jdbc4.0
                                    //support go ahead with EmbeddedXADataSource
                            ...
                            //Added by Jeff Huang
                            return new org.apache.derby.jdbc.EmbeddedXADataSource();
                        }
		}
