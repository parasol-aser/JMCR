...
// $Id: CvsDAVFileFrame.java,v 1.2 2010/06/15 17:53:14 smhuang Exp $
...
public class CvsDAVFileFrame extends DAVFrame {
	...
	try {
	    cls = 
	      Class.forName("org.w3c.jigedit.webdav.frames.CvsDAVFileFrame") ;
	    //Added by Jeff Huang
	    //TODO: FIXIT
	} catch (Exception ex) {
	    ex.printStackTrace() ;
    ...
    protected synchronized Reply deleteFileResource(Request request)
	throws ProtocolException, ResourceException
    {
	if (fresource == null) {
