// DoubleAttributeEditor.java
// $Id: DoubleAttributeEditor.java,v 1.1 2010/06/15 12:20:42 smhuang Exp $
...
import org.w3c.jigadmin.widgets.DoubleTextField;
...
public class DoubleAttributeEditor extends AttributeEditor {
	...
	try {
	    return new Double(widget.getText());
    ...
    public DoubleAttributeEditor() {
	widget = new DoubleTextField();
