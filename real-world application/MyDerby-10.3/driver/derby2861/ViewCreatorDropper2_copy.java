...
public class ViewCreatorDropper2_copy implements Runnable {
     ...
     */
    public ViewCreatorDropper2_copy(String viewName, String sourceName, String columns, int iterations)
    {
        m_viewName = viewName;
