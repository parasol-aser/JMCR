...
public class Derby2862_copy
{
    ...
    static public void main(String[] args)
    {
    	...
    	try
        {
            Derby2862_copy instance = new Derby2862_copy();
     ...
     */
    private Derby2862_copy() throws ClassNotFoundException
    {
    	try {
...
//        
	...
	public void test() throws InterruptedException {
    	Derby2862_copy.main(new String[]{});
	}
