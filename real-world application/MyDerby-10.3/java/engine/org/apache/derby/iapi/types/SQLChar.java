...
readingLoop:
   ...
   * @exception StandardException thrown on failure to convert
	...
	*/
	...
	public int stringCollatorCompare(SQLChar char2) {
		// TODO Auto-generated method stub
		CollationKey ckey1 = null;
		CollationKey ckey2 = null;
		try {
			ckey1 = this .getCollationKey();
			ckey2 = char2.getCollationKey();
		} catch (StandardException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.err.println("Jeff: Exception in SQLChar.stringCollatorCompare");
		}
