...
//        System.out.println("memory model:" + RVConfig.instance.mode);
        ...
        //this seems useless
        //TODO: solve this bug
//        RVGlobalStateForInstrumentation.instance.initSharedData();        
...
//                            new ClassReader(bytes).accept(new CheckClassAdapter(new TraceClassVisitor(new PrintWriter(System.out)), true), 0);
                        }
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
