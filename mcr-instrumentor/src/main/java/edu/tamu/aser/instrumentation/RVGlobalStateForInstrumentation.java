...
/**
 * Mark the shared memory to instrument from an outside file
 */
...
//		try
//		{
////			fis = new FileInputStream(FILE_SHARED_VARIABLE);
    ...
    public boolean isThreadClass(String cname) {
        while (!cname.equals(OBJECT_CLASS_NAME)) {
            if (cname.equals(THREAD_CLASS_NAME))
                return true;
            //Alan: handling reentrantlock
//            if (cname.equals(REENTRANTLOCK_NAME)) {
//                return true;
//            }
